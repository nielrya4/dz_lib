...
def test():
    samples_array = data.excel_to_array("/home/ryan/Desktop/dz_data/mda_test.xlsx")
    ...
    result = mda.youngest_gaussian_fit(grains)
    print(f"youngest gaussian fit: {result[0].age} uncertainty: {result[0].uncertainty}")
